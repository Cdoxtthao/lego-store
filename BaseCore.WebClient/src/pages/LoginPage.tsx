...
const LoginPage = () => {
  ...
  const handleSubmit = async (e: React.SyntheticEvent) => {
    ...
    try {
      ...
      if (["Admin", "Seller", "Supplier"].includes(response.role))
        navigate("/admin");
      else navigate("/");
    } catch (err: any) {
  ...
  return (
    <div className="min-h-screen bg-flower-50 flex flex-col">
      ...
      <div className="text-center pt-10 pb-6">
        <Link to="/">
          <h1
            className="text-4xl font-bold text-flower-100"
      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-10">
        ...
        >
          ...
          <p className="text-gray-500 text-sm mb-6">
            ...
            <Link
              to="/register"
              className="text-flower-100 hover:underline transition-all duration-200"
            >
              tạo tài khoản
            </Link>
          </p>
      ...
      <div className="text-center py-6 border-t border-gray-200">
        <p className="text-xs text-gray-400">
          ...
          <a href="/terms" className="text-flower-100 hover:underline">
            Điều khoản dịch vụ
          </a>{" "}
          và{" "}
          <a href="/privacy" className="text-flower-100 hover:underline">
            Chính sách bảo mật
          </a>{" "}
          của chúng tôi.
        </p>
